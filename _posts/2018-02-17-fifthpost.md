---
layout: post_page
title: Aircraft Design <br> (Estimating preliminary design parameters) <br>
...
프로펠러 항공기의 최적 순항 시의 양항비는 $$(L/D)_{cruise} = (L/D)_{max}$$ 이고 제트 항공기의 경우 최적 순항 시의 양항비는 $$(L/D)_{cruise} = 0.866(L/D)_{max}$$
...
$$W_{f}/W_{0} = 1.06\(1-\frac{W_{7}}{W_{0}}\)$$
...
$$(\frac{T_{altitude}}{W_{remained}}) \geq \frac{C_{D_{0}}q}{W_{remained}/S}+\frac{K}{q} \frac{W_{remained}}{S}$$
...
$$R/C = V \(\frac{T}{W}-\frac{D}{W}\) = V \{\frac{T}{W}-\frac{qC_{D_{0}}}{(W/S)}-\frac{K}{q}\(\frac{W}{S}\)\}$$

피스톤엔진과 프로펠러 항공기의 추력 특성과 중량 보정을 포함하면
$$R/C = 550\nu_{p}\(\frac{hp_{SL}}{W_{0}}\)-\frac{1}{2}\rho V^{3} \frac{C_{D_{0}}}{(W_{0}/S)}-\frac{2K}{\rho V}\(\frac{W_{0}}{S}\)$$

최대상승률이 발생하는 속도는 R/C를 속도로 미분하여 얻을 수 있음.
$$V=\sqrt{\frac{2}{\rho}\(\frac{W_{0}}{S}\)\sqrt{\frac{K}{3C_{D_{0}}}}}$$

high bypass 터보팬엔진 항공기의 추력 특성과 중량 보정을 포함하면
$$R/C = V \{ \(\frac{W_{0}}{W_{remained}}\)\frac{a\sigma}{10V}\(\frac{T_{SL}}{W_{0}}\)-\(\frac{W_{0}}{w_{remained}}\)\frac{qC_{D_{0}}}{(W_{0}/S)}-\frac{K}{q}\\(\frac{W_{remained}}{W_{0}}\)(\frac{W_{0}}{S}\)\}$$

최대상승률이 발생하는 속도는
$$V = \sqrt{\frac{2}{\rho}\(\frac{W_{remained}}{W_{0}}\)\(\frac{W_{0}}{S}\)\sqrt{\frac{K}{3C_{D_{0}}}}}$$ 

(3) 상승한계
표에서 항공기 타입에 따른 최대 상승률(R/C)을 찾고 상승 한계에 적용함.
피스톤엔진과 프로펠러 항공기의 상승한계는
$$\(\frac{hp_{SL}}{W_{0}}\) \geq \frac{\rho C_{D_{0}}}{1100 \nu} \(\frac{V^{3}}{W_{0}/S}\)+\(\frac{K}{275 \nu_{p}}\)\frac{1}{V}\(\frac{W_{0}}{S}\)+\frac{R/C}{550 \nu_{p}}$$

high bypass 터보팬엔진 항공기의 상승한계는 
$$ \(\frac{T_{SL}}{W_{0}}\) \geq \frac{r\rho C_{D_{0}}}{a \sigma} \frac{V^{3}}{(W_{0}/S)}+\(\frac{W_{remained}}{W_{0}}\)^{2} \(\frac{a \sigma K}{5\rho}\) \frac{1}{V} \(\frac{W_{0}}{S}\)$$
...
제트 항공기의 경우
$$\(\frac{W_{0}}{S} \leq (TOP)\sigma \C_{L_{TO}}\(frac{T_{SL}}{W_{0}}\)\)$$

프로펠러 항공기의 경우
$$\(\frac{W_{0}}{S} \leq (TOP)\sigma \C_{L_{TO}}\(frac{hp_{SL}}{W_{0}}\)\)$$
